...
This project is indexed by GitNexus as **claude-plugins-official** (7781 symbols, 15144 relationships, 274 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/claude-plugins-official/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/claude-plugins-official/context` | Codebase overview, check index freshness |
| `gitnexus://repo/claude-plugins-official/clusters` | All functional areas |
| `gitnexus://repo/claude-plugins-official/processes` | All execution flows |
| `gitnexus://repo/claude-plugins-official/process/{name}` | Step-by-step execution trace |
